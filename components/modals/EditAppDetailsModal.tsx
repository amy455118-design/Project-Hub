...
import { App, Partnership, Project } from '../../types';
...
export const EditAppDetailsModal: React.FC<EditAppDetailsModalProps> = ({ isOpen, onClose, t, app, partnerships, projects, onSave }) => {
    ...
    const handleSave = () => {
        onSave({ ...app, username, password, url, partnershipId, projectIds });
    };
            ...
            <div className="bg-latte-mantle dark:bg-mocha-mantle rounded-xl p-8 w-full max-w-lg" onClick={e => e.stopPropagation()}>
                ...
                <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
                    <div>
                        ...
                        <input type="text" placeholder={t.username} value={username} onChange={e => setUsername(e.target.value)} className={`${inputStyle} mt-2`} />
                        <input type="text" placeholder={t.password} value={password} onChange={e => setPassword(e.target.value)} className={`${inputStyle} mt-2`} />
                    </div>
                    <div>
                    ...
                    <div>
                        <h3 className="font-semibold pt-2">{t.projects}</h3>
