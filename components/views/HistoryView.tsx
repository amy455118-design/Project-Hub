...
export const HistoryView: React.FC<{ t: any, history: HistoryEntry[] }> = ({ t, history }) => {
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-latte-text dark:text-mocha-text">{t.history}</h1>
            </div>
